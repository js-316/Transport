    ...
    [
        ...
        ? {
            ...
            submenu: [
              ...
              },
              {
                ...
                active:
                  location.pathname === "/dashboard/vehichles/meter_history",
              },
              {
                name: "Expense History",
                path: "/dashboard/vehichles/expenses_history",
                active:
                  location.pathname === "/dashboard/vehichles/expenses_history",
              },
            ],
          }
        : null,
      ...
      user?.is_staff || user?.is_engineer || user?.is_human_resource_manager
        ? {
            ...
            icon: "icon material-icons md-style",
            active: location.pathname === "/dashboard/maintenance/job_card",
          }
        : null,
      ...
      user?.is_staff || user?.is_engineer
        ? {
            ...
            active: location.pathname === "/dashboard/machinery",
          }
        : null,
      user?.is_staff || user?.is_engineer
        ? {
            ...
            submenu: [
              {
                ...
                active:
                  location.pathname ===
                  "/dashboard/inspections/insspection_history",
              },
              {
                name: "Item failures",
                path: "/dashboard/inspections/item_failures",
                active:
                  location.pathname === "/dashboard/inspections/item_failures",
              },
              {
                name: "Schedules",
                path: "/dashboard/inspections/schedules",
                active:
                  location.pathname === "/dashboard/inspections/schedules",
              },
            ],
          }
        : null,
      ...
      user?.is_staff || user?.is_engineer
        ? {
            ...
            icon: "icon material-icons md-analytics",
            active: location.pathname === "/dashboard/charts",
          }
        : null,
      {
        name: "Logout",
