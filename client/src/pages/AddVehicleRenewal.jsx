    ...
    <Layout>
      <div className="row">
        ...
        <div className="content-header">
            <div>
              <div>
                <Link to="/dashboard/vehicle_reminders">
                  <FontAwesomeIcon icon={faArrowCircleLeft} />Vehicle Renewals
                </Link>
              </div>
              <h2 className="content-title">
                New Vehicle Renewal Reminder</h2>
            </div>
        ...
        <div className="col-lg-12">
          <div className="card mb-4">
            <div className="card-header">
              <h4>Vehicle Renewal Reminder Information</h4>
            </div>
            <div className="card-body">
              ...
              <form id="fuel_form" onSubmit={handleSubmit(handleAddFuel)}>
                <div className="row">
                  ...
                  <div className="col-lg-4">
                    <div className="mb-4">
                      <label className="form-label">Vehicle Renewal Type</label>
                      <div className="row gx-2">
                        <input
                          placeholder="Please select"
                          type="text"
                          className={`form-control ${
                            errors.vehicle_renewal_type ? "is-invalid" : ""
                          }`}
                          {...register("vehicle_renewal_type")}
                        />
                        {errors.vehicle_renewal_type && (
                          <div className="invalid-feedback">
                            {errors.vehicle_renewal_type?.message}
                          </div>
                        )}
                      </div>
                    </div>
                ...
                <button class="btn btn-primary" type="submit">
                  {isLoading ? "Adding..." : "Save Vehicle Renewal"}
                </button>
              </form>
            </div>
          </div>
