...
const vehichleSchema = yup.object().shape({
  ...
  vehichle_type: yup.string().required("Vehicle Type is required"),
...
const fuelSchema = yup.object().shape({
  ...
  fuel_plate: yup.string().required("Vehicle is required"),
  mileage: yup.number().required("Mileage is required"),
  date_of_fueling: yup.string().required("Date of fueling is required"),
...
const jobCardSchema = yup.object().shape({
  ...
  //quantity_needed: yup.number().required("Quantity is required").min(1, "Quantity must be greater than 1"),
  //part_needed: yup.string().required("Part is required"),
